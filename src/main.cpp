...
void test_get_slice() {
    ...
    // Test 2: Slice with reverse traversal
    Tensor<FLOAT32> slice2 = test.get_slice(start_indices, end_indices, -1);
    std::cout << "Test 2: Reverse traversal slice" << std::endl;
    print_tensor(slice2);
    ...
    std::vector<int> mixed_end{3, 2, -1};
